...
%   Authors: Xiaosong Li, Fuqiang Zhou, et al.   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% 
th=3;   border_omit_mapA=border_omit(finalmap1,th);      border_omit_mapB=border_omit(finalmap2,th);
mid_dif1 = dif1.*border_omit_mapA;           mid_dif2 = dif2.*border_omit_mapB;
%%
