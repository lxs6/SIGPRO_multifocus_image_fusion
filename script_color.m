...
source_f1=imread('lytro-01-A.jpg');  source_f2=imread('lytro-01-B.jpg');     % input source images
...
no_borderA=border_o(finalmap1,th2);      no_borderB=border_o(finalmap2,th2);
%%
f11=im2double(source_f1);         f22=im2double(source_f2);
dif1=temp_fused-f11;       dif2=temp_fused-f22;     
final_fused = zeros(size(f11));
    for i=1:3
        mis_infor1(:,:,i) = dif1(:,:,i).*no_borderA;  
        mis_infor2(:,:,i) = dif2(:,:,i).*no_borderB;
